...
public class CashierManagement {
    ...
    public static void main(String[] args) {
        ...
        do {
            System.out.print("Masuk ke Admin Access (y/n)? ");
            ...
            if (isAdminMode) {
                ...
                System.out.println();
                System.out.println("--------------------------------------------------");
                System.out.println("        Selamat Datang di Kasir Minimarket        ");
                System.out.println("--------------------------------------------------");
                ...
                System.out.println("Total harga: " + currencyFormat.format(cashier.getTotalPrice()));
